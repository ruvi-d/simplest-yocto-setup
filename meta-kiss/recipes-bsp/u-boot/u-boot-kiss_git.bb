# nooelint: oelint.var.mandatoryvar.SUMMARY oelint.var.mandatoryvar.DESCRIPTION oelint.var.mandatoryvar.HOMEPAGE oelint.var.mandatoryvar.LICENSE
...
# stm32mp1 is a SOC_FAMILY override (see stompduck.conf), not a MACHINE,
# so oelint cannot derive it from the constants DB.
# nooelint: oelint.vars.specific
SRC_URI:append:stm32mp1 = " \
    file://env-on-mmc0-4-ext4.cfg \
...
# stm32mp1 is a SOC_FAMILY override (see above).
